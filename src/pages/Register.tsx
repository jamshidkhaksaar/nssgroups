      ...
      <div className="w-full max-w-md mx-auto">
        <Reveal>
          ...
          <form ref={formRef} onSubmit={handleRegister} className="space-y-5">
            ...
            <button 
              type="submit" 
              className="nss-btn-primary flex w-full items-center justify-center gap-2 rounded-sm py-4 text-sm font-bold uppercase tracking-wider mt-2"
            >
          ...
          <p className="mt-8 text-center text-sm text-[rgba(var(--text-rgb),0.6)]">
            {t('auth.hasAccount')}{' '}
            <Link to="/login" className="font-semibold text-[rgb(var(--gold-rgb))] hover:underline">
              {t('auth.loginLink')}
            </Link>
          </p>
        </Reveal>
